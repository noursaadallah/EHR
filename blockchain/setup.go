...
func (setup *FabricSetup) InstallAndInstantiateCC() error {
	...
	installCCReq := resmgmt.InstallCCRequest{Name: setup.ChainCodeID, Path: setup.ChaincodePath, Version: ccVersion, Package: ccPkg}
	...
	err = setup.admin.InstantiateCC(setup.ChannelID, resmgmt.InstantiateCCRequest{Name: setup.ChainCodeID, Path: setup.ChaincodePath, Version: ccVersion, Args: [][]byte{[]byte("init")}, Policy: ccPolicy})
	if err != nil {
